...
const UserReservations = () => {
  ...
  const handleCancel = (res) => {
    ...
    if (hotel) {
      updateHotel(hotel.id, {
        ...hotel,
        rooms: { ...hotel.rooms, [res.roomType]: hotel.rooms[res.roomType] + res.quantity }
      });
    }
  ...
  const handleSave = (res) => {
    ...
    if (editRoom === res.roomType) {
      ...
      updateHotel(hotel.id, {
        ...hotel,
        rooms: { ...hotel.rooms, [res.roomType]: hotel.rooms[res.roomType] - diff }
      });
    } else {
      ...
      updateHotel(hotel.id, {
        ...hotel,
        rooms: { ...hotel.rooms, [editRoom]: hotel.rooms[editRoom] - editQuantity }
      });
    }
  ...
  return (
    <>
      ...
      <div className="container mt-5">
        <Button variant="secondary" className="mb-4" onClick={() => navigate("/dashboard-user")}>
          ← Volver al Dashboard
        </Button>
